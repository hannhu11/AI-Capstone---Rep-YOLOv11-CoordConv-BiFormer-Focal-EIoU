...
\midrule
\textbf{Rep-YOLO11s (Ours, Single Checkpoint)} & 9.85 & 22.4 & 94.83 & 62.54 & 94.44 & 91.33 & 0.9190 & \textbf{1.51}$^\dagger$ & \textbf{662.2}$^\dagger$ \\
\textbf{Rep-YOLO11s (5-Fold Mean $\pm$ SD)} & 9.85 & 22.4 & \textbf{96.64} $\pm$ \textbf{0.32} & \underline{65.91} $\pm$ 0.46 & \underline{94.94} $\pm$ 0.47 & 93.01 $\pm$ 0.73 & \textbf{0.9396} & \textbf{1.51}$^\dagger$ & \textbf{662.2}$^\dagger$ \\
\bottomrule
\multicolumn{10}{l}{\small \textit{Note:} `\textemdash' indicates metrics not explicitly reported in original papers. $^\dagger$ Evaluated on TensorRT 11.2 FP16 on NVIDIA RTX 3050 Laptop GPU ($640\times640$).}
\end{tabular}%
}
\end{table*}
...
$A_6$ & \textbf{Full Fusion (Proposed)} & \textbf{94.83} & \textbf{62.54} & \textbf{91.33} & \textbf{1.51}$^\star$ \\
\bottomrule
\multicolumn{6}{l}{\small Lat. = Pure GPU Forward Latency at $640\times640$.} \\
\multicolumn{6}{l}{\small $^\star$ Measured after RepConv \textsf{switch\_to\_deploy} TensorRT FP16 conversion.}
\end{tabular}%
}
\end{table}

As shown in Table~\ref{tab:ablation_study}, inserting CoordConv ($A_2$) improves spatial coordinate awareness and feature localization. Adding BiFormer ($A_5$) concentrates attention on tiny helmet regions. Finally, RepConv fusion ($A_6$) collapses inference latency from $7.12\text{~ms}$ to $1.51\text{~ms}$ without any loss in precision, providing an optimal efficiency-accuracy trade-off.
...
\quad Rep-YOLO11s-640 (Thanh) & $640\times640$ & 96.30 & 91.49 & 96.40 & 77.90 \\
\quad Rep-YOLO11s-960 (Thanh) & $960\times960$ & 95.54 & 93.92 & 97.85 & 78.93 \\
\quad Baseline A6 Full Train (Nhu) & $640\times640$ & 95.56 & 94.57 & 97.28 & 68.26 \\
\quad Proposed Rep-YOLO11s Fix-6 (Nhu) & $640\times640$ & 93.29 & 87.28 & 94.03 & 60.37 \\
\quad SHWD-YOLO11s-DA (Dung) & $960\times960$ & 92.13 & 88.71 & 93.32 & 72.29 \\
\quad SHWD-YOLO11s-LO (Dung) & $960\times960$ & 91.61 & 89.30 & 93.33 & 72.44 \\
\midrule
\multicolumn{6}{l}{\textbf{2. GDUT-HWD Standardized (External Construction Benchmark, 13,499 Images)}} \\
\quad Baseline A6 Full Train (Nhu) & $640\times640$ & 91.31 & 69.55 & 74.76 & 37.87 \\
\quad Proposed Rep-YOLO11s Fix-6 (Nhu) & $640\times640$ & 90.26 & 68.35 & 74.27 & 39.00 \\
\quad SHWD-YOLO11s-DA (Dung) & $960\times960$ & 94.18 & 67.75 & 73.59 & 38.01 \\
\quad SHWD-YOLO11s-LO (Dung) & $960\times960$ & 94.54 & 66.77 & 74.26 & 39.11 \\
\midrule
\multicolumn{6}{l}{\textbf{3. SHEL5K Standardized (Complex Multi-Scale PPE, 5,000 Images)}} \\
\quad Baseline A6 Full Train (Nhu) & $640\times640$ & 88.87 & 39.05 & 41.15 & 24.44 \\
\quad Proposed Rep-YOLO11s Fix-6 (Nhu) & $640\times640$ & 85.62 & 37.65 & 40.93 & 22.84 \\
\quad SHWD-YOLO11s-DA (Dung) & $960\times960$ & 93.15 & 37.55 & 40.72 & 24.98 \\
\quad SHWD-YOLO11s-LO (Dung) & $960\times960$ & 92.45 & 37.43 & 40.96 & 24.36 \\
\midrule
\multicolumn{6}{l}{\textbf{4. Hard Hat Workers / AndrewMVD (7,000 Images)}} \\
\quad Rep-YOLO11s-640 (Hat-Only Protocol, Thanh) & $640\times640$ & 94.68 & 92.74 & 96.90 & 55.05 \\
\quad Rep-YOLO11s-960 (Hat-Only Protocol, Thanh) & $960\times960$ & 94.81 & 92.69 & \textbf{97.03} & 54.74 \\
\quad SHWD-YOLO11s-DA (Joint Protocol, Dung) & $960\times960$ & 93.93 & 68.70 & 73.73 & 42.22 \\
\quad SHWD-YOLO11s-LO (Joint Protocol, Dung) & $960\times960$ & 93.23 & 68.99 & 74.40 & 43.85 \\
\midrule
\multicolumn{6}{l}{\textbf{5. Safety Helmet Detection (SHD Benchmark)}} \\
\quad Rep-YOLO11s-640 (Thanh) & $640\times640$ & 92.87 & 70.21 & 76.79 & 43.28 \\
\quad Rep-YOLO11s-960 (Thanh) & $960\times960$ & 92.94 & 70.12 & 76.85 & 42.63 \\
\midrule
\multicolumn{6}{l}{\textbf{6. SFCHD (Safety Helmet Face \& Head Benchmark)}} \\
\quad SHWD-YOLO11s-DA (Dung) & $960\times960$ & 81.30 & 55.15 & 64.06 & 36.32 \\
\quad SHWD-YOLO11s-LO (Dung) & $960\times960$ & 79.65 & 55.75 & 64.80 & 37.35 \\
\bottomrule
\end{tabular}%
}
\end{table*}
...
Table~\ref{tab:deployment} reports measured deployment latency and throughput across target hardware platforms, execution engines, and input resolutions. Batch-one inference at $960\times960$ on an NVIDIA Tesla T4 GPU achieves $\mathbf{48.7\text{~FPS}}$ ($20.53\text{~ms}$) in PyTorch FP32 and $\mathbf{48.8\text{~FPS}}$ in FP16, with the CCTV stream pipeline reaching $\mathbf{64.2\text{--}70.0\text{~FPS}}$ ($14.28\text{~ms}$). At $640\times640$ on an edge RTX 3050 Laptop GPU, TensorRT FP16 forward execution requires only $\mathbf{1.51\text{~ms}}$ ($\mathbf{662.2\text{~FPS}}$), while Edge CPU execution achieves $\mathbf{35.0\text{~FPS}}$ ($\mathbf{28.56\text{~ms}}$).

\begin{table}[t]
\caption{Measured Deployment Latency and Throughput across Target Hardware Platforms.}
...
\midrule
NVIDIA RTX 3050 & TensorRT 11.2 FP16 & $640\times640$ & 1.51 & 662.2 \\
NVIDIA Tesla T4 & TensorRT 11.2 FP16 & $640\times640$ & 2.14 & 467.3 \\
Intel Core i7 (4C) & ONNX Runtime INT8 & $640\times640$ & 28.56 & 35.0 \\
RTSP Pipeline (RTX 3050) & End-to-End Stream & $640\times640$ & 10.54--15.34 & 65--95 \\
\bottomrule
\end{tabular}%
}
\end{table}

\subsection{Latency Measurement Integrity: Resolving Asynchronous Artifacts}
A vital finding of our deployment audit concerns the measurement of GPU inference speed. Naive CPU host timers wrapping non-blocking CUDA kernel launches measure CPU queue submission overhead ($\sim 10\,\mu\text{s}$) rather than actual device execution time, producing non-physical throughput estimates (e.g., $>50,000\text{ FPS}$). In this work, all reported GPU latencies are strictly synchronized using \textsf{torch.cuda.synchronize()} and CUDA event timers, establishing physically verified benchmarks bounded by NVIDIA Turing compute capacity ($65\text{ TFLOPs}$ FP16).
...
\begin{enumerate}
    ...
    \item \textbf{Preprocessing \& Letterboxing ($T_{prep}$)}: Aspect-ratio preserving resizing and normalization to $640\times640\times3$ tensor ($1.2\text{--}2.0\text{~ms}$).
    \item \textbf{TensorRT GPU Inference ($T_{gpu}$)}: Pure FP16 model forward execution ($1.51\text{--}2.14\text{~ms}$).
...
&\approx 10.54\text{~ms} \text{--} 15.34\text{~ms},
\end{aligned}
\end{equation}
...
In this paper, we presented \textbf{Rep-YOLO11s}, a structural re-parameterized object detector engineered for real-time safety helmet detection in complex construction environments. By integrating RepConv multi-branch fusion, Spatial CoordConv coordinate channels, BiFormer bi-level routing attention, and Focal EIoU Loss, Rep-YOLO11s addresses key industrial challenges including tiny distant target loss, class imbalance, and background clutter. Evaluated on the SHWD benchmark, Rep-YOLO11s achieves $94.83\%$ $mAP_{50}$ (with 5-fold cross-validation reaching $96.64 \pm 0.32\%$), while delivering $48.7\text{~FPS}$ at $960\times960$ on Tesla T4 and $662.2\text{~FPS}$ ($1.51\text{~ms}$) at $640\times640$ on an edge RTX 3050 GPU. Comprehensive zero-shot evaluations across five external industrial datasets validate the model's operational robustness and transferability.
