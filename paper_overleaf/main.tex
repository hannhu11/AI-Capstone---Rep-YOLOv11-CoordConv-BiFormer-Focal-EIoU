...
\begin{itemize}
    ...
    \item Conversely, SHEL5K represents a significant domain gap ($40.96\%$ $mAP_{50}$) primarily attributable to severe multi-level label ambiguity in its native annotation schema (nested overlaps among \textsf{helmet}, \textsf{head\_with\_helmet}, and \textsf{face}) combined with distant, heavily occluded tiny targets ($<15\times15$ pixels) captured from high-angle surveillance vantage points.
\end{itemize}
