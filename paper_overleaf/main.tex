...
\multicolumn{10}{l}{\small $^\dagger$ Pure GPU forward latency evaluated with TensorRT 11.2 FP16 on NVIDIA Tesla T4 ($640\times640$); achieves 5.35~ms (187.1~FPS) on edge RTX 3050 Laptop GPU.}
\end{tabular}%
}
\end{table*}
