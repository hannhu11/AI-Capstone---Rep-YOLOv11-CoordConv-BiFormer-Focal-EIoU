"""
Generator script to produce a 100% self-contained Native Master Jupyter Notebook.
All classes, functions, converters, models, Grad-CAM, K-Fold CV, Fine-tuning,
Knowledge Distillation, and INT8 calibration are written directly inside notebook cells.
Zero external .zip or .py script dependencies.
"""
...
def create_master_notebook():
    ...
    # -------------------------------------------------------------
    # CELL 1: Markdown Title & Academic Context
    # -------------------------------------------------------------
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
    ...
    # -------------------------------------------------------------
    # CELL 2: Environment Check & Dependency Installation
    # -------------------------------------------------------------
    cells.append({
        "cell_type": "code",
    ...
    # -------------------------------------------------------------
    # CELL 3: Embedded Custom Modules (CoordConv, RepConv, BiFormer, Focal-EIoU)
    # -------------------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    # -------------------------------------------------------------
    # CELL 4: VOC-to-YOLO Converter & Leak-Free Dataset Builder
    # -------------------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    # -------------------------------------------------------------
    # CELL 5: [Stage 1] Inlined Grad-CAM XAI Comparison
    # -------------------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    # -------------------------------------------------------------
    # CELL 6: [Stage 2] Inlined 5-Fold Stratified Cross-Validation Runner
    # -------------------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    # -------------------------------------------------------------
    # CELL 7: [Stage 3] Inlined Hard-Case Augmentation Fine-Tuning (12 Epochs)
    # -------------------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    # -------------------------------------------------------------
    # CELL 8: [Stage 4] Inlined Multi-Scale Knowledge Distillation
    # -------------------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    # -------------------------------------------------------------
    # CELL 9: [Stage 5] Inlined TensorRT INT8 Quantization & Simulation
    # -------------------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    # -------------------------------------------------------------
    # CELL 10: Compact Output Zip Exporter
    # -------------------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    out_paths = [
        Path("shwd-stage-3-kaggle-master-research-pipeline-fix-6.ipynb"),
        Path("shwd-stage-3-kaggle-master-research-pipeline-fix-5.ipynb"),
        Path("shwd-stage-3-kaggle-master-research-pipeline-fixed.ipynb"),
        Path("shwd-stage-3-kaggle-master-research-pipeline-5.ipynb"),
        Path("shwd-stage-3-kaggle-master-research-pipeline-4.ipynb"),
        Path("notebooks/SHWD_Stage3_Kaggle_Master.ipynb")
    ]
    ...
    for p in out_paths:
        ...
        print(f"✅ Generated Native Master Notebook at: {p.resolve()}")
